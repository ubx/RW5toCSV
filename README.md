...
usage: java -jar RW5toCSV.jar args
 ...
 -t,--TXT output file <arg>    text file to write comments, optional. If not specified the output is <file-name>.txt in the same directory as the input file
 -v,--version of the program   prints the version nummer of the program
